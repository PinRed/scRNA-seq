...
\begin{document}
	...
	\begin{frame}{All gene PCA}
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.8\linewidth]{Figure/allgene.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		\frametitle{All gene + DEA}
			...
			\begin{minipage}[t]{0.50\textwidth} 
				...
				\label{fig:gene-a}
				\vspace{0.5em}
				\includegraphics[width=\linewidth]{Figure/volcano_dea.png}
	...
	\begin{frame}{500 HVG PCA}
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.8\linewidth]{Figure/hvgs.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{minipage}[t]{0.50\textwidth} 
			...
			\label{fig:gene-a}
			\vspace{0.5em}
			\includegraphics[width=\linewidth]{Figure/volcano_hvg.png}
		...
		\begin{minipage}[t]{0.50\textwidth} 
			...
			\label{fig:gene-a}
			\vspace{0.5em}
			\includegraphics[width=\linewidth]{Figure/hvg_dea_pca.png}			
		\end{minipage}%
	...
	\begin{frame}{Sparse PCA}
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.8\linewidth]{Figure/spca.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{minipage}[t]{0.50\textwidth} 
			...
			\label{fig:gene-a}
			\vspace{0.5em}
			\includegraphics[width=\linewidth]{Figure/volcano_spca.png}
		...
		\begin{minipage}[t]{0.50\textwidth} 
			...
			\label{fig:gene-a}
			\vspace{0.5em}
			\includegraphics[width=\linewidth]{Figure/spca_dea_pca.png}			
		\end{minipage}%
	...
	\begin{frame}{Intersection DEA, HVG, SPCA}
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.8\linewidth]{Figure/Venn.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{HVG + DEA + SPCA}
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.8\linewidth]{Figure/hvg_dea_spca.png}
		\end{figure}
	\end{frame}
